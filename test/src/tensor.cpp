...
TEST(tensor, create_1d) {
    ...
    ASSERT_EQ(tensor->shape().dims()[0], 25);
    ASSERT_EQ(tensor->shape().dims()[1], 1);
    ASSERT_EQ(tensor->shape().dims()[2], 1);
    ASSERT_EQ(tensor->shape().dims()[3], 1);
    ASSERT_EQ(tensor->shape().strides()[0], sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[1], 25*sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[2], 25*sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[3], 25*sizeof(float));
}
...
TEST(tensor, create_2d) {
    ...
    ASSERT_EQ(tensor->shape().dims()[0], 4);
    ASSERT_EQ(tensor->shape().dims()[1], 4);
    ASSERT_EQ(tensor->shape().dims()[2], 1);
    ASSERT_EQ(tensor->shape().dims()[3], 1);
    ASSERT_EQ(tensor->shape().strides()[0], sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[1], 4*sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[2], 4*4*sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[3], 4*4*sizeof(float));
}
...
TEST(tensor, create_3d) {
    ...
    ASSERT_EQ(tensor->shape().dims()[0], 4);
    ASSERT_EQ(tensor->shape().dims()[1], 4);
    ASSERT_EQ(tensor->shape().dims()[2], 8);
    ASSERT_EQ(tensor->shape().dims()[3], 1);
    ASSERT_EQ(tensor->shape().strides()[0], sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[1], 4*sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[2], 4*4*sizeof(float));
    ASSERT_EQ(tensor->shape().strides()[3], 4*4*8*sizeof(float));
}
